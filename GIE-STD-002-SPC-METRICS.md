...
$$S_c(\vec{I}, \vec{P}) = \frac{\vec{I} \cdot \vec{P}}{||\vec{I}|| ||\vec{P}||}$$
...
$$D_{TED}(T_{agent}, T_{policy}) = \min_{\gamma} \{ \sum_{e \in \gamma} cost(e) \}$$
...
$$\delta_{res} > 0.05 \quad \text{OR} \quad D_{TED} > \lambda$$
